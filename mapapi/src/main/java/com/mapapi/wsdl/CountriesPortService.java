 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://spring.io/guides/gs-producing-web-service", wsdlLocation = "file:/C:/Users/areli/OneDrive/Escritorio/SD2025-2/SistemasDistribuidos-2025-2/mapapi/src/main/resources/wsdl/countries.wsdl")
public class CountriesPortService
    extends Service
{

    private static final URL COUNTRIESPORTSERVICE_WSDL_LOCATION;
    private static final WebServiceException COUNTRIESPORTSERVICE_EXCEPTION;
    private static final QName COUNTRIESPORTSERVICE_QNAME = new QName("http://spring.io/guides/gs-producing-web-service", "CountriesPortService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/areli/OneDrive/Escritorio/SD2025-2/SistemasDistribuidos-2025-2/mapapi/src/main/resources/wsdl/countries.wsdl");
